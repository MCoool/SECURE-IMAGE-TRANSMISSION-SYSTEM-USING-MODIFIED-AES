...
im = Image.open('decrypted_encrypted_shuffling.png')
px = im.load()
w, h = im.size
...
im.save('decrypted shuffling.jpg', optimize=False, progressive=False, quality=100)
...
cv2.imwrite('decrypted.png',new_img,params=None)